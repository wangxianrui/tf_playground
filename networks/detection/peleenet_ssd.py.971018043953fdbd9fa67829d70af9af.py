...
class PeleeNetSSD:
    def __init__(self):
        ...
        self.all_anchors = anchors_all_layers()
    ...
    def forward(self, inputs, is_train):
        ...
        with tf.variable_scope('detection'):
            ...
            locations = [
                tf.reshape(loc, [batch_size, -1, 4]) for loc in locations
            ]
            classes = [
                tf.reshape(cla, [batch_size, -1, Param.num_classes])
                for cla in classes
            ]
    ...
    def calc_loss(self, pred_locations, pred_classes, groundtruth,
        ...
        :return:
        '''
        target_location, target_label, target_score = encode_groundtruch(
